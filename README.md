...
| `/yersil reload`          | `config.yml` dosyasını diskten yeniden yükler, zamanlayıcıyı tazeler.     | `yersil.komut`  |
| `/yersilsure <saniye>`    | Temizleme periyodunu günceller, `config.yml`'e kaydeder. (`/yersilsüre` alias'ı da kullanılabilir) | `yersil.komut`  |

## ⚙️ Kurulum

1. [Releases](../../releases) sayfasından ya da kendi derlediğiniz `YerSil-1.0.4.jar` dosyasını indirin.
